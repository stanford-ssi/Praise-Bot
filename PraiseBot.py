...
def generateText(message):
    ...
    prompt = "write " + prompt_choice + " to " + message ". If you're unsure what you're thanking them for, choose something generic about contributing to the Stanford Student Space Initiative. Do not add any fields that I need to fill in (such as [Your name])."
